...
<html>
	...
	<body>
		<a href="#create-businessUser" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
...
<%--			</ul>--%>
<%--		</div>--%>
		<div id="create-businessUser" class="content scaffold-create col-lg-12" role="main">
			...
			<g:form url="[resource:businessUserInstance, action:'save']" >
				<fieldset class="form">
