...
<div class="fieldcontain ${hasErrors(bean: organizerInstance, field: 'password', 'error')} required">
	...
	<g:textField name="password" required="" value="${organizerInstance?.password}"/>
...
<div class="fieldcontain ${hasErrors(bean: organizerInstance, field: 'gender', 'error')} required">
	...
	<g:select name="gender" from="${com.standconnect.security.SecUser$Gender?.values()}" keys="${com.standconnect.security.SecUser$Gender.values()*.name()}" required="" value="${organizerInstance?.gender?.name()}" />
...
<div class="fieldcontain ${hasErrors(bean: organizerInstance, field: 'events', 'error')} ">
	<label for="events">
		<g:message code="organizer.events.label" default="Events" />
...
<li class="add">
<g:link controller="event" action="create" params="['organizer.id': organizerInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'event.label', default: 'Event')])}</g:link>
</li>
</ul>
