...
<%--            </ul>--%>
<%--        </div>--%>
        <div id="create-event" class="content scaffold-create col-lg-12" role="main">
            <div class="row title-row">
				<div class="col-lg-10"><h1 class="big-title"><g:message code="default.enroll.label" default="_Enrol" /></h1></div>
			</div>
