		...
		<div id="list-event" class="content scaffold-list col-lg-12" role="main">
			...
			<thead>
					<tr>
						...
						<sec:ifAnyGranted roles='ROLE_ADMIN,ROLE_BUSINESSUSER'><th><!-- LIST --></th></sec:ifAnyGranted>
...
<%--									${fieldValue(bean: eventInstance, field: "image")}--%>
							...
							<sec:ifAnyGranted roles='ROLE_ADMIN,ROLE_BUSINESSUSER'>
							     <td>
							         <g:link class="btn btn-success btn-enrol" controller="event" action="enroll"  id="${eventInstance.id}">
							             <span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;
							             <g:message code="event.enroll.label" default="_Enrol" />
							         </g:link>
						         </td>
						    </sec:ifAnyGranted>
							...
							<td class="options">
							  <div class="btn-group">
								  ...
								  <ul class="dropdown-menu">
								    ...
								    <li onclick="deleteForm${eventInstance.id}.click();" class="deleteli">
								    	...
								    	<g:form url="[resource:eventInstance, action:'delete']" method="DELETE">
											<g:actionSubmit hidden id="deleteForm${eventInstance.id}" action="delete" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" />
										</g:form>
	                                </li>
								  </ul>
							  </div>
