...
<%--			</ul>--%>
<%--		</div>--%>
		<div id="edit-stand" class="content scaffold-edit col-lg-12" role="main">
			...
			<g:form url="[resource:standInstance, action:'update']" method="PUT"  enctype="multipart/form-data">
				<g:hiddenField name="version" value="${standInstance?.version}" />
				<fieldset class="form">
