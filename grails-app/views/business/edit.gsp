...
<%--			</ul>--%>
<%--		</div>--%>
		<div id="edit-business" class="content scaffold-edit col-lg-12" role="main">
			...
			<g:form url="[resource:businessInstance, action:'update']" method="PUT"  enctype="multipart/form-data">
