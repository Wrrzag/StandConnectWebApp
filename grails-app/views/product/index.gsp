							...
							<td class="options">
							  <div class="btn-group">
								  ...
								  <ul class="dropdown-menu">
								    ...
								    <li onclick="deleteForm${productInstance.id}.click();" class="deleteli">
								    	<a><span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;&nbsp;<g:message code="default.button.delete.label" default="_Delete" /></a>
								    	<g:form url="[resource:productInstance, action:'delete']" method="DELETE">
											<g:actionSubmit hidden id="deleteForm${productInstance.id}" action="delete" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" />
										</g:form>
	                                </li>
								  </ul>
							  </div>
