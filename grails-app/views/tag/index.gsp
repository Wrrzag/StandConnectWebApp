							...
							<td class="options">
							  <div class="btn-group">
								  ...
								  <ul class="dropdown-menu">
								    ...
								    <li onclick="deleteForm${tagInstance.id}.click();" class="deleteli">
								    	...
								    	<g:form url="[resource:tagInstance, action:'delete']" method="DELETE">
											<g:actionSubmit hidden id="deleteForm${tagInstance.id}" action="delete" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" />
										</g:form>
	                                </li>
								  </ul>
							  </div>
